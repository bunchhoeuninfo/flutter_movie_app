...
import 'package:movie_app/features/bookmarks/data/datasource/local/bookmark_local_datasource_impl.dart';
import 'package:movie_app/features/bookmarks/data/repositories/bookmark_repository_impl.dart';
...
import 'package:movie_app/features/home/data/datasource/local/home_local_datasource.dart';
...
import 'package:movie_app/features/home/domain/use_cases/fetch_cached_genre_use_case.dart';
import 'package:movie_app/features/home/domain/use_cases/fetch_cached_movies_use_case.dart';
import 'package:movie_app/features/movie_detail/data/datasource/local/movie_detail_local_datasource.dart';
import 'package:movie_app/features/movie_detail/data/datasource/local/movie_detail_local_datasource_impl.dart';
import 'package:movie_app/features/movie_detail/data/datasource/remote/movie_detail_remote_data_source.dart';
import 'package:movie_app/features/movie_detail/data/datasource/remote/movie_detail_remote_datasource.dart';
import 'package:movie_app/features/movie_detail/data/repositories/movie_detail_repository_impl.dart';
...
import 'package:movie_app/features/notifications/data/datasource/local/notifications_local_datasource.dart';
import 'package:movie_app/features/notifications/data/datasource/local/notifications_local_datasource_impl.dart';
import 'package:movie_app/features/notifications/data/repository/notification_repository_impl.dart';
import 'package:movie_app/features/notifications/domain/repository/notifications_repository.dart';
import 'package:movie_app/features/notifications/domain/use_cases/clear_all_notifications_use_case.dart';
import 'package:movie_app/shared/local/cache/local_db.dart';
import 'package:movie_app/shared/local/cache/local_db_impl.dart';
import 'package:movie_app/shared/local/shared_prefs/shared_pref.dart';
import 'package:movie_app/shared/local/shared_prefs/shared_pref_impl.dart';
